package com.backend.biblioteca.configuration;

import com.backend.biblioteca.service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authenticationProvider(authenticationProvider()) // Asegurar que el provider esté configurado
                ...
                .formLogin(form -> form
                        .loginPage("/login")
                        .defaultSuccessUrl("/web/libros", true)
